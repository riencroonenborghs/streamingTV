...
bozon.task('scripts:main', function() {
  bozon.src('javascripts/**/*.coffee')
    .pipe(coffee({bare: true}))
    .pipe(bozon.dest('javascripts'));
  bozon.src("javascripts/libs/**/*.js")
    .pipe(bozon.dest("javascripts/libs"))
  return bozon.src("views/**/*.html")
    .pipe(bozon.dest("views"));
});
